...
public class Student_Profile extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        new_Class_Field = new javax.swing.JTextField();
        ...
        jPanel4.add(new_Phone_Field, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 210, 350, 30));
        ...
        jPanel4.add(new_department_Field, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 250, 350, -1));

        nameLabel2.setFont(new java.awt.Font("UD Digi Kyokasho N-B", 0, 20)); // NOI18N
        nameLabel2.setText("Phone Number");
        jPanel4.add(nameLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 210, 144, 30));

        departLabel.setFont(new java.awt.Font("UD Digi Kyokasho N-B", 0, 20)); // NOI18N
        departLabel.setText("Department");
        jPanel4.add(departLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 250, -1, 20));
        ...
        jPanel4.add(create_newUser_Button, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 300, -1, 30));
        ...
        jPanel4.add(createButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 300, -1, 30));
        ...
        nameLabel4.setText("Class");
        jPanel4.add(nameLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, 80, 30));

        new_Class_Field.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        new_Class_Field.setText("Enter your class");
        new_Class_Field.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                new_Class_FieldMouseClicked(evt);
            }
        });
        new_Class_Field.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                new_Class_FieldActionPerformed(evt);
            }
        });
        jPanel4.add(new_Class_Field, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 170, 350, 30));
    ...
    private void create_newUser_ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_create_newUser_ButtonActionPerformed
        try{
            ...
            String newClass = new_Class_Field.getText();
            ...
            if(newDepartment == "Student"){
                ...
                String sql = "INSERT INTO lecturers(ID,Lecturer_password, Full_Name, Technical, Phone_number,Achievement) VALUES('"+newUserID+"','"+newUserPass+"','"+newFullName+"','"+newClass+"','"+newPhone+"')";
    ...
    private void new_Class_FieldMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_new_Class_FieldMouseClicked
        this.new_Class_Field.setText("");
    }//GEN-LAST:event_new_Class_FieldMouseClicked

    private void new_Class_FieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_new_Class_FieldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_new_Class_FieldActionPerformed
    ...
    private javax.swing.JTextField new_Class_Field;
